...
#ifndef EEPROM_THREAD_H_
#define EEPROM_THREAD_H_
#include "bsp_api.h"
#include "FreeRTOS.h"
#include "task.h"
#include "semphr.h"
#include "hal_data.h"
#ifdef __cplusplus
                extern "C" void eeprom_thread_entry(void * pvParameters);
                #else
extern void eeprom_thread_entry(void *pvParameters);
#endif
#include "r_sci_i2c.h"
